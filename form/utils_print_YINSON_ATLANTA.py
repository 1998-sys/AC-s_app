...
def gerar_ac_yinson_atlanta(dados, caminho_pdf_original):
    ...
    caminho_template = "TemplateAC_YINSON - ATLANTA.xlsx"
    ...
    if categoria in (
        ...
        ws["C2"] = "Análise Crítica de Calibração dos Sensores de Temperatura"
        ...
        ws["C2"] = "Análise Crítica de Calibração dos Transmissores de Pressão"
        ...
        ws["C2"] = "Análise Crítica de Calibração dos Transmissores de Pressão Diferencial"
