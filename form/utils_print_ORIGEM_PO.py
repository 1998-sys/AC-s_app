...
def gerar_ac_origem_PO(dados, caminho_pdf_original):
    """
    Preenche o template Excel de AC Origem PO com os dados fornecidos e exporta como PDF.
    Fills the AC Origem PO Excel template with the provided data and exports it as PDF.
